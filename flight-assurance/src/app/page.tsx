...
import { Battery, Radio, GripVertical, Wand2 } from "lucide-react";
            ...
            <div className="relative h-full rounded-r-xl overflow-hidden">
              ...
              {(!showUploader && !showAreaOpsUploader && !showWizard && !flightPlan && !aoGeometry) && (
                <div className="absolute inset-0 bg-black/50 flex items-center justify-center z-20 p-4">
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden w-full max-w-4xl">
                    ...
                    <div className="flex flex-row p-6 gap-4">
                      ...
                      >
                        ...
                        <p className="text-sm text-gray-500">Upload a flight plan to verify its integrity and analyse hazards and terrain</p>
                      ...
                      >
                        ...
                        <h4 className="font-medium text-gray-900">Guided Wizard</h4>
                        <p className="text-sm text-gray-500">Step-by-step setup to customize your flight planning</p>
                        <p className="text-sm text-purple-500">Perfect for tailored analysis</p>
                      </button>
                    </div>
                  </div>
                </div>
              ...
              {showUploader && (
                <div className="absolute inset-0 bg-black/50 flex items-center justify-center z-20 p-4">
                  <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-4xl">
                    <h3 className="text-xl font-semibold mb-4">Flight Plan Upload</h3>
                    <FlightPlanUploader
              ...
              {showAreaOpsUploader && (
                <div className="absolute inset-0 bg-black/50 flex items-center justify-center z-20 p-4">
                  <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-4xl">
                    <h3 className="text-xl font-semibold mb-4">Area of Operations Upload</h3>
                    <AreaOpsUploader
              ...
              {showWizard && (
                <div className="absolute inset-0 bg-black/50 flex items-center justify-center z-20 p-4">
                  <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-4xl">
                    <h3 className="text-xl font-semibold mb-4">Flight Planning Wizard</h3>
