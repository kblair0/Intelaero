...
export interface AnalysisStats {
  visibleCells: number;         // Number of fully visible cells
  totalCells: number;           // Total number of cells analyzed
  averageVisibility: number;    // Average visibility percentage
